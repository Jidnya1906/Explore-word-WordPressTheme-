...
get_header();
?>
<header class="bg-light text-center py-5" style=" background-image: url('imgs/Nohkalikai_Falls.jpg');
    ...
    <div class="testimonial-container">
       <div class="testimonial-slider" id="testomonial-slider">
            <!--  <div class="testimonial">
                <img src="imgs/image 59 (1).png" alt="">
            ...
            <div class="testimonial">
                <img src="imgs/image 59 (2).png" alt="">
                <button class="wishlist-btn" onclick="toggleWishlist(this)">
                    <span class="heart">&#10084;</span>
                </button>
            ...
            <div class="testimonial">
                <img src="imgs/image 59 (3).png" alt="">
                <button class="wishlist-btn" onclick="toggleWishlist(this)">
                    <span class="heart">&#10084;</span>
                </button>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        fetchData("Nature",filename,filepath);
    });
</script>
